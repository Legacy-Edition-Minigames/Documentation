...
#. All content must meet a quality bar.
...
Rules for all maps
------------------
These are the rules for maps in the **Featured** and **Verified** category
...
#. No use of Generative AI
    * Generative AI is prohibited for use in: Map Descriptions; Preview Images; Map art; In-game text; In-game music.
    * This list is non-extensive, please exercise best judgement regarding Generative AI use.
#. No NSFW / Sexual Content, symbols, builds, textures & sounds. 
...
#. Malicious Content is prohibited
...
#. Battle maps must be no larger than 25 MB when compiled.
...
#. Maps must meet the minimum defined requirements in :doc:`/modtools/creation/requirements`
